...
return [
    ...
    App\Application\GamePokemon\UsuarioBundle\ApplicationGamePokemonUsuarioBundle::class => ['all' => true],
    App\Application\GamePokemon\RankingBundle\ApplicationGamePokemonRankingBundle::class => ['all' => true],
